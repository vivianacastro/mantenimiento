...
class Modelo_registros
{
   ...
   public function insertarOrdenes($nombre, $sede, $campus, $edificio, $piso, $espacio, $contacto, $cantidad, $descripcion, $cantidad2, $descripcion2, $cantidad3, $descripcion3, $otranovedad, $otranovedad2, $otranovedad3)
    ...
    /**
     * funcion quer permite buscar los edificios de la sede melendez
    ...
    public function buscarDBNovedad()
    {
        ...
        if(strcmp($_SESSION["perfil"], 'mobiliario') == 0){
          $sql = "SELECT novedad_sistema.id, novedad_sistema.novedad, novedad_sistema.cod_sistema FROM novedad_sistema JOIN sistema ON novedad_sistema.cod_sistema = sistema.cod_sistema ORDER BY sistema.sistema, novedad_sistema.novedad;";
        }else{
          $sql = "SELECT novedad_sistema.id, novedad_sistema.novedad, novedad_sistema.cod_sistema FROM novedad_sistema JOIN sistema ON novedad_sistema.cod_sistema = sistema.cod_sistema WHERE novedad_sistema.id <> '46' ORDER BY sistema.sistema, novedad_sistema.novedad;";
        }
